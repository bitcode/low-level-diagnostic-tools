...
| **/a**:# | **Auto Expand** \- Use /a:0 to start Dependency Walker with the [Auto Expand](https://www.dependencywalker.com/help/html/hidm_auto_expand.htm) setting initially turned off, or /a:1 to start with it turned on. If this option is not specified, then the setting from the last time you ran Dependency Walker will be used. |
| **/f**:# | **View full paths** \- Use /f:0 to start Dependency Walker with the [View Full Paths](https://www.dependencywalker.com/help/html/hidm_view_full_paths.htm) setting initially turned off, or /f:1 to start with it turned on. If this option is not specified, then the setting from the last time you ran Dependency Walker will be used. |
| **/u**:# | **Undecorate C++ functions** \- Use /u:0 to start Dependency Walker with the [Undecorate C++ Functions](https://www.dependencywalker.com/help/html/hidm_view_undecorated.htm) setting initially turned off, or /u:1 to start with it turned on. If this option is not specified, then the setting from the last time you ran Dependency Walker will be used. |
...
| **/sm**:# | **Sort column for module list view**\- This option controls the initial sort column that Dependency Walker will use when sorting the items in the [Module List View](https://www.dependencywalker.com/help/html/hidr_module_list_view.htm). If this option is not specified, then the value from the last time you ran Dependency Walker will be used. The values allowed are:<br> <br>01. Icon<br>    <br>02. Module Name or Path<br>    <br>03. File Time Stamp<br>    <br>04. Link Time Stamp<br>    <br>05. File Size<br>    <br>06. File Attributes<br>    <br>07. Link Checksum<br>    <br>08. Real Checksum<br>    <br>09. CPU Type<br>    <br>10. Subsystem Type<br>    <br>11. Symbol Types<br>    <br>12. Preferred Base Address<br>    <br>13. Actual Base Address<br>    <br>14. Virtual Size<br>    <br>15. Load Order<br>    <br>16. File Version<br>    <br>17. Product Version<br>    <br>18. Image Version<br>    <br>19. Linker Version<br>    <br>20. OS Version<br>    <br>21. Subsystem Version |
| **/si**:# | **Sort column for parent import function list view** \- This option controls the initial sort column that Dependency Walker will use when sorting the items in the [Parent Import Function List View](https://www.dependencywalker.com/help/html/hidr_import_list_view.htm). If neither this option or the /sf option is specified, then the value from the last time you ran Dependency Walker will be used. The values allowed are:<br>1. Icon<br>   <br>2. Ordinal Value<br>   <br>3. Hint Value<br>   <br>4. Function Name<br>   <br>5. Entry Point Address |
| **/se**:# | **Sort column for export function list views**\- This option controls the initial sort column that Dependency Walker will use when sorting the items in the [Export Function List View](https://www.dependencywalker.com/help/html/hidr_export_list_view.htm). If neither this option or the /sf option is specified, then the value from the last time you ran Dependency Walker will be used. The values allowed are:<br>1. Icon<br>   <br>2. Ordinal Value<br>   <br>3. Hint Value<br>   <br>4. Function Name<br>   <br>5. Entry Point Address |
| **/sf**:# | **Sort column for both function list views**\- This option controls the initial sort column that Dependency Walker will use when sorting the items in both the [Parent Import Function List View](https://www.dependencywalker.com/help/html/hidr_import_list_view.htm) and the [Export Function List View](https://www.dependencywalker.com/help/html/hidr_export_list_view.htm). If no sort column option is specified for a particular column, then the value(s) from the last time you ran Dependency Walker will be used. The values allowed are:<br>1. Icon<br>   <br>2. Ordinal Value<br>   <br>3. Hint Value<br>   <br>4. Function Name<br>   <br>5. Entry Point Address |
...
| **/d**:path | **Dependency Walker Path (DWP) file to load** \- This options allows you to specify a [Dependency Walker Path (DWP) File](https://www.dependencywalker.com/help/html/path_files.htm) to load and use as the initial search path when searching for modules. DWP files can be created using the [Configure \<br>Module Search Order](https://www.dependencywalker.com/help/html/hidm_configure_search_order.htm) command in Dependency Walker. |
...
|  | |     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | Options are case insensitive. For example, "/c" and "/C" are equivalent. |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | Options may start with a slash or a dash. For example, "/c" and "-c" are equivalent. |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | The colons (:) shown in the options above are optional. They may be removed or replaced with spaces. For example, "/f:0", "/f 0", and "/f0" are equivalent. |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | All profiling options are cumulative from left to right. For example, /pa:1 /pm:0 will turn on all the profiling options, then turn off the "Log debug output messages" option, but /pm:0 /pa:1 will simply turn on all profiling options. |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | Program options intended for Dependency Walker must come before the module path. All options after the module path will be passed to the module as its command line when profiled. |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | If you wish to specify text that has spaces, that text should be placed in quotes. For example: |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | depends /pb /oc "c:\\output files\\foo bar.csv" "c:\\input files\\foo bar.exe" 1 2 3 "this is a test" |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | Multiple options can be grouped together. You may even append options to other options that require numerical values. The only options that cannot be appended to are options that require a path or text values (-pd, -od, -ot, -of, -oc, and -d). For example: | |
...
|  | |     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | All options can be specified with or without the "Console Mode" option (/c). |

|     |     |
| --- | --- |
| ![bullet](https://www.dependencywalker.com/help/images/bullet1.gif) | More than one output file type option can be specified. | |

**Return Values**

|     |     |
| --- | --- |
|  | When Dependency Walker exits, it returns a set of bit flags that are OR'ed together. There are three groups of error flags - module warnings, module errors, and processing errors. The error flags have been arranged in a way that makes it easy to detect the severity of a problem.<br>If the return value is greater than or equal to 0x00010000, then there was a processing error with Dependency Walker and no work was done. Otherwise, if the return value is greater than or equal to 0x00000100, then the operating system will not be able to load the module due to some module or dependency error. Otherwise, if the return value is greater than or equal to 0x00000001, then the module has no load-time dependency problems and will most likely have no problems loading, but may have runtime problems. |
...
| 0x00000020 | At least one module failed to load during profiling. This usually occurs when a module returns 0 from its DllMain function or generates an unhandled exception while processing the DLL\_PROCESS\_ATTACH message. | |
